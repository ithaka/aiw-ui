...
export const rights = [
  ...
  { name: 'NO COPYRIGHT UNITED STATES',
    link: 'http://rightsstatements.org/vocab/NoC-US/1.0/',
    img: '/assets/img/rights-statements/NoC.Icon-Only.dark.png'
  },
  // OTHER RIGHTS STAEMENTS
  { name: 'COPYRIGHT NOT EVALUATED',
    link: 'http://rightsstatements.org/vocab/CNE/1.0/',
    img: '/assets/img/rights-statements/Other.Icon-Only.dark.png'
  },
  ...
  { name: 'NO KNOWN COPYRIGHT',
    link: 'http://rightsstatements.org/vocab/NKC/1.0/',
    img: '/assets/img/rights-statements/Other.Icon-Only.dark.png'
  }
]
