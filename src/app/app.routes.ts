...
export const ROUTES: Routes = [
  ...
  { path: 'object/:openLibId', component: AssetPage, pathMatch: 'full' },
  ...
  { path: 'asset/openlibrary/external/:encryptedOpenLibId', component: AssetPage, pathMatch: 'full' },
  ...
  { path: 'ssid/:ssid', component: SsidMapping, canActivate: [AuthService] },
